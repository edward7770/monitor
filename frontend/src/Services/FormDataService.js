...
export const getForm193RecordsAPI = async (currentPage, pageSize, sortModel, filterModel) => {
    try {
...
export const getForm187RecordsAPI = async (currentPage, pageSize, sortModel, search) => {
  try {
