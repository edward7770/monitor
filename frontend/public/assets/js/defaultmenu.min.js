...
function toggleSidemenu() {
  ...
  if (window.innerWidth >= 992) {
    if (sidemenuType === "vertical") {
      document.getElementById("sidebar").removeEventListener('mouseenter', mouseEntered);
      document.getElementById("sidebar").removeEventListener('mouseleave', mouseLeave);
      document.getElementById("sidebar").removeEventListener('click', icontextOpen);
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              ...
              document.getElementById("sidebar").addEventListener('mouseenter', mouseEntered);
              document.getElementById("sidebar").addEventListener('mouseleave', mouseLeave);
            }
            else {
              document.getElementById("sidebar").removeEventListener('mouseenter', mouseEntered);
              document.getElementById("sidebar").removeEventListener('mouseleave', mouseLeave);
        ...
        case "icontext":
          ...
          if (html.getAttribute('data-toggled') === 'icon-text-close') {
            ...
            if (window.innerWidth >= 992) {
              document.getElementById("sidebar").addEventListener('click', icontextOpen);
