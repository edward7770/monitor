...
// const sidebar = document.getElementById("sidebar") && document.getElementById("sidebar");
...
class Poppers {
  ...
  init() {
    document.querySelectorAll(".nav > ul > .slide.has-sub").forEach((element) => {
 ...
 */
document.querySelectorAll(".nav > ul > .slide.has-sub > a").forEach((element) => {
 ...
 */
document.querySelectorAll(".nav > ul > .slide.has-sub .slide.has-sub > a").forEach((element) => {
  let html = document.querySelector('html');
...
function toggleSidemenu() {
  ...
  if (window.innerWidth >= 992) {
    if (sidemenuType === "vertical") {
      document.getElementById("sidebar") && document.getElementById("sidebar").removeEventListener('mouseenter', mouseEntered);
      document.getElementById("sidebar") && document.getElementById("sidebar").removeEventListener('mouseleave', mouseLeave);
      document.getElementById("sidebar") && document.getElementById("sidebar").removeEventListener('click', icontextOpen);
      document.querySelector(".main-content").removeEventListener('click', icontextClose);
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              ...
              document.getElementById("sidebar") && document.getElementById("sidebar").addEventListener('mouseenter', mouseEntered);
              document.getElementById("sidebar") && document.getElementById("sidebar").addEventListener('mouseleave', mouseLeave);
            }
            else {
              document.getElementById("sidebar") && document.getElementById("sidebar").removeEventListener('mouseenter', mouseEntered);
              document.getElementById("sidebar") && document.getElementById("sidebar").removeEventListener('mouseleave', mouseLeave);
        ...
        case "icontext":
          ...
          if (html.getAttribute('data-toggled') === 'icon-text-close') {
            ...
            if (window.innerWidth >= 992) {
              document.getElementById("sidebar") && document.getElementById("sidebar").addEventListener('click', icontextOpen);
              document.querySelector(".main-content").addEventListener('click', icontextClose);
            }
            else {
              document.getElementById("sidebar") && document.getElementById("sidebar").removeEventListener('click', icontextOpen);
              document.querySelector(".main-content").removeEventListener('click', icontextClose);
